...
5. Then install virtual python environment in backedn2 folder (python -m venv folder_name).
6. You are ready to run the file , run backend2 (node app.js) and run project (npm run dev).
